\begin{frame}
	...
	\vspace{5mm}
	\PN \onslide<2->{Recordemos, que por definición de $<: a < b \Leftrightarrow a \leq b$ y $a \neq b$}

	\vspace{3mm}
	\PN \onslide<3->{Antes de comenzar, enunciaremos y probaremos lo siguiente:
	\begin{center}
		\begin{tabular}{|c|} \hline $a < b \Rightarrow f(a) <^{\prime} f(b)$ \\\hline \end{tabular} $(\dag)$
	\end{center}
	}

	\PN \onslide<4->{\underline{En palabras:} $f$ isomorfismo preserva el menor estricto.}
\end{frame}
